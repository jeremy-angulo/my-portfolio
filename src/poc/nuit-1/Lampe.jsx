...
export const FournisseurLampe = ({ heroRef, lang, children }) => {
  ...
  // Refs attachées par CartePortrait : la lune (position de repos) et la carte
...
const Lampe = ({ eclose }) => {
  ...
  return (
    <motion.div className="nuit1-lampe" aria-hidden="true" style={{ transform }}>
      <motion.span
        className="nuit1-lampe__disque"
