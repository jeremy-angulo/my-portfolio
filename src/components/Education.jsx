...
const FeedbackCard = ({
  ...
  >
      <div className='mt-7 flex flex-col justify-between items-center gap-1'>
        ...
        <div className='mt-3 flex-1 flex flex-col'>
          <div className='text-center text-white font-medium text-[16px]'>
            <span className='text-center blue-text-gradient whitespace-pre-line'>{name}</span> 
          </div>
    ...
    <p className='text-white font-black text-[48px] p-10'> </p>

    <div className='mt-1'>
      <p className='text-center text-white tracking-wider text-[18px] whitespace-pre-line'>{degree}</p>
      <p className='mt-3 text-center pink-text-gradient whitespace-pre-line'>{branch}</p>
      <p className='mt-3 text-center green-text-gradient whitespace-pre-line'>{marks}</p>
