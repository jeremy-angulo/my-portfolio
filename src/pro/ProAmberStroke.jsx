// src/pro/ProAmberStroke.jsx
// Le trait d'ambre tracé sous un mot : la signature de la facette jour.
//
 ...
 */
const ProAmberStroke = ({ delay = 0, duration = 620, statique = false }) => (
  <svg
    className="day-word__stroke"
    viewBox="0 0 100 12"
