...
import { useLampe } from "./NightLamp";

/**
 * @param {{ ui: object, reduit: boolean }} props
 */
const NightPortrait = ({ ui, reduit }) => {
  ...
  return (
    ...
    >
      ...
      <div className="night-portrait__lune-parallaxe" aria-hidden="true">
        <motion.span
          ref={luneRef}
          className="night-portrait__lune"
      ...
      <span className="night-portrait__ombre" aria-hidden="true" />

      <div className="night-portrait__parallaxe">
        <motion.div
          ref={carteRef}
          className="night-portrait__carte"
        ...
        >
          <span className="night-portrait__lisere" aria-hidden="true" />
          <img src={jeremy} alt={ui.alt} />
        </motion.div>
      </div>

      <motion.span
        className="night-portrait__chip night-portrait__chip--bas"
