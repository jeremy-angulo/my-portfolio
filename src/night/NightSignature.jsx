...
import { EASE_PLUME } from "./nightMotion";
 ...
 */
const NightSignature = ({ texte, onSigne, className }) => {
  ...
  return (
    <motion.span
      className={`night-nom${className ? ` ${className}` : ""}`}
      style={{ "--p": pTexte }}
      onPointerEnter={onPointerEnter}
    >
      <span className="night-nom__texte">{texte}</span>
      {pointVisible && (
        <motion.span
          className="night-nom__point"
          aria-hidden="true"
