...
// Sonde de viewport partagée par tout le site.
//
...
// premier consommateur, retirée au démontage du dernier. L'appelant n'a rien à
// rendre.
 ...
 *
 * `--vp-h` vaut la HAUTEUR ENTIÈRE du viewport, pas 1 % : une scène de
 * 2,6 écrans s'écrit `height: calc(var(--vp-h) * 2.6)`, et 6 % de viewport
 * `calc(var(--vp-h) * 0.06)`.
 */
const useViewport = ({ el = null, varWidth = "--vp-w", varHeight = "--vp-h" } = {}) => {
