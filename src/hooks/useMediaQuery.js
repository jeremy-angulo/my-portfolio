...
// Une media query évaluée en JS, pour brancher/débrancher un effet exactement
// là où le CSS le fait.
// Les media queries ne sont PAS affectées par `body { zoom: 0.85 }` :
